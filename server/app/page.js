...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7170)), "D:\\kiddebuddepage\\src\\app\\page.js"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
        'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6972)), "D:\\kiddebuddepage\\src\\app\\layout.js"],
...
const pages = ["D:\\kiddebuddepage\\src\\app\\page.js"];
...
;// CONCATENATED MODULE: ./src/api/route.js
async function getMeta(slug) {
    const res = await fetch(`https://kb.safelearners.co.in/api/kbworld/viewPostDetails/650415db9c200728ecb5794f`, {
        cache: "no-store"
    });
...
function RootLayout({ children }) {
    return /*#__PURE__*/ jsx_runtime_namespaceObject.jsx("html", {
        lang: "en",
        children: /*#__PURE__*/ jsx_runtime_namespaceObject.jsx("body", {
...
var __webpack_exports__ = __webpack_require__.X(0, [604,241,309], () => (__webpack_exec__(1834)));
